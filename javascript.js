...
function start() {
	...
	while(document.getElementById("leftPic").src === document.getElementById("rightPic").src || document.getElementById("leftPic").src === "http://localhost/") {
...
function newLeftPic() {
	...
	if ("http://localhost/images/" + pics[randomNumberLeft][0] === document.getElementById("leftPic").src
	|| document.getElementById("rightPic").src === "http://localhost/images/" + pics[randomNumberLeft][0]
	//|| Rb < (Ra - 20)
	) {
		console.log("OH NO");
		newLeftPic();
		...
		for(i = 0; i < pics.length; i++) {
			if (document.getElementById("leftPic").src === "http://localhost/images/" + pics[i][0] && Sa === 0) {
				randomNumberRight = i;
...
function newRightPic() {
	...
	if ("http://localhost/images/" + pics[randomNumberRight][0] === document.getElementById("rightPic").src
	|| document.getElementById("leftPic").src === "http://localhost/images/" + pics[randomNumberRight][0]
	//|| Ra < (Rb - 20)
	)	{
		console.log("OH NO");
		newRightPic();
		...
		for(i = 0; i < pics.length; i++) {
			if (document.getElementById("rightPic").src === "http://localhost/images/" + pics[i][0] && Sb === 0) {
				randomNumberLeft = i;
		$(document).ready(function() {
			$.ajax({
			type: "POST",
